...
fn tint_symbol_106(tint_symbol_79_1 : vec2i, tint_symbol_23_7 : vec3f, tint_symbol_28_10 : vec3f) {
  ...
  if ((tint_symbol_107.x >= 0.0f)) {
    ...
    tint_symbol_80_1.w = tint_symbol_110;
  } else {
    tint_symbol_80_1 = x_1359;
  }
  let x_1815 = tint_symbol_80_1;
  textureStore(tint_symbol_73, tint_symbol_79_1, x_1815);
  return;
}

const x_1837 = vec2f(2.0f);
...
fn tint_symbol_123_inner(tint_symbol_124 : vec3u) {
  ...
  var x_1833 : bool;
  var x_1834 : bool;
  let x_1820 = bitcast<vec2i>(tint_symbol_124.xy);
  let x_1823 = bitcast<vec2i>(vec2i(textureDimensions(tint_symbol_73)));
  let x_1828 = (x_1820.x < x_1823.x);
  x_1834 = x_1828;
  if (x_1828) {
    x_1833 = (x_1820.y < x_1823.y);
    x_1834 = x_1833;
  }
  if (x_1834) {
    let x_1842 = (x_1837 / tint_symbol_70.inner.tint_symbol_66.xy);
    tint_symbol_37_1 = vec3f((((f32(x_1820.x) + 0.5f) * x_1842.x) - 1.0f), (((f32(x_1820.y) + 0.5f) * x_1842.y) - 1.0f), 0.0f);
    tint_symbol_127 = vec3f(0.0f, 0.0f, 1.0f);
    let x_1860 = tint_symbol_37_1;
    let x_1859 = tint_symbol_76(x_1860);
    tint_symbol_37_1 = x_1859;
    let x_1862 = tint_symbol_127;
    let x_1861 = tint_symbol_74(x_1862);
    tint_symbol_127 = x_1861;
    let x_1864 = tint_symbol_37_1;
    let x_1865 = tint_symbol_127;
    tint_symbol_106(x_1820, x_1864, x_1865);
  }
  return;
}

fn tint_symbol_123_1() {
  let x_1870 = tint_symbol_124_1;
  tint_symbol_123_inner(x_1870);
  return;
}
...
fn tint_symbol_128_inner(tint_symbol_124_3 : vec3u) {
  ...
  var x_1886 : bool;
  var x_1887 : bool;
  let x_1874 = bitcast<vec2i>(tint_symbol_124_3.xy);
  let x_1876 = bitcast<vec2i>(vec2i(textureDimensions(tint_symbol_73)));
  let x_1881 = (x_1874.x < x_1876.x);
  x_1887 = x_1881;
  if (x_1881) {
    x_1886 = (x_1874.y < x_1876.y);
    x_1887 = x_1886;
  }
  if (x_1887) {
    let x_1891 = tint_symbol_70.inner.tint_symbol_65;
    let x_1894 = tint_symbol_70.inner.tint_symbol_66;
    tint_symbol_37_2 = vec3f();
    let x_1905 = (((vec2f(x_1874) - (tint_symbol_70.inner.tint_symbol_66 * 0.5f)) + vec2f(0.5f)) * ((x_1891 * x_1837) / x_1894.xy));
    tint_symbol_127_1 = vec3f(x_1905.x, x_1905.y, 1.0f);
    let x_1911 = tint_symbol_37_2;
    let x_1910 = tint_symbol_76(x_1911);
    tint_symbol_37_2 = x_1910;
    let x_1913 = tint_symbol_127_1;
    let x_1912 = tint_symbol_74(x_1913);
    tint_symbol_127_1 = x_1912;
    let x_1915 = tint_symbol_37_2;
    let x_1916 = tint_symbol_127_1;
    tint_symbol_106(x_1874, x_1915, x_1916);
  }
  return;
}

fn tint_symbol_128_1() {
  let x_1920 = tint_symbol_124_2;
  tint_symbol_128_inner(x_1920);
  return;
}
