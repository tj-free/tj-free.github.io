...
export default class ParticleSystemObject extends SceneObject {
  ...
  async createParticleGeometry() {
    // Create particles
    this._particles = new Float32Array(this._numParticles * 8); // [x, y, ix, iy, vx, vy, ls, ils]
  ...
  resetParticles() {
    ...
    for (let i = 0; i < this._numParticles; ++i) {
      ...
      this._particles[10 * i + 4] = (Math.random() * prtSpd - prtSpd/2); // [-1, 1] 
      this._particles[10 * i + 5] = (Math.random() * prtSpd - prtSpd/2);
