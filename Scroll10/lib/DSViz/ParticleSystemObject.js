...
export default class ParticleSystemObject extends SceneObject {
  ...
  resetParticles() {
    ...
    for (let i = 0; i < this._numParticles; ++i) {
      // random position on a line between [-0.5, 0.5] x [0.75, 0.75]
      this._particles[10 * i + 0] = (Math.random() * 1 - 0.5); // [-1, 1] 
      this._particles[10 * i + 1] = 0.75; //(Math.random() * 2 - 1);
      ...
      this._particles[10 * i + 4] = 0//(Math.random() * prtSpd - prtSpd/2);
