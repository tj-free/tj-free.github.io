...
export default class Standard2DPGAPosedTextureObject extends SceneObject {
  constructor(device, canvasFormat, vertices, pose, img) {
  ...
  async createShaders() {
    let shaderCode = await this.loadShader("/shaders/standard2dpgatexture.wgsl");
